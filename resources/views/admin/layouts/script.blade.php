<!-- Core -->
<script src="{{ asset('assets/backend/vendor/popper.js/dist/umd/popper.min.js') }}"></script>
...
<!-- JQuery JS -->
<script src="{{ asset('assets/backend/vendor/jquery/jquery-3.5.1.min.js') }}"></script>

<!-- Slider -->
<script src="{{ asset('assets/backend/vendor/nouislider/distribute/nouislider.min.js') }}"></script>

<!-- Jarallax -->
<script src="{{ asset('assets/backend/vendor/jarallax/dist/jarallax.min.js') }}"></script>

<!-- Smooth scroll -->
<script src="{{ asset('assets/backend/vendor/smooth-scroll/dist/smooth-scroll.polyfills.min.js') }}"></script>

<!-- Count up -->
<script src="{{ asset('assets/backend/vendor/countup.js/dist/countUp.umd.js') }}"></script>
