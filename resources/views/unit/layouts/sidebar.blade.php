<nav id="sidebarMenu" class="sidebar d-md-block bg-primary text-white collapse" data-simplebar>
  <div class="sidebar-inner px-4 pt-3">
      ...
      <ul class="nav flex-column">
          ...
          <li class="nav-item {{ Request::route()->getName() == 'unit.kursus.home' ? 'active' : '' }}">
          ...
          <li
          class="nav-item {{ (request()->is('unit/siswa/*')) ? 'active' : '' }}">
          ...
          <div class="multi-level collapse {{ (request()->is('unit/siswa/*')) || request()->is('manager/pendaftar-unit*') || request()->is('manager/siswa-unit*') ? 'show' : '' }}"
              role="list" id="submenu-siswa" aria-expanded="false">
              <ul class="flex-column nav">
                  <li class="nav-item {{ (Request::route()->getName() == 'unit.siswa.kelompok') ? 'active' : '' }}">
                      <a class="nav-link" href="{{ route('unit.siswa.kelompok') }}"><span>Kursus Kelompok</span></a>
                  </li>
                  <li class="nav-item {{ (Request::route()->getName() == 'unit.siswa.private') ? 'active' : '' }}">
