        ...
        <div class="col-lg-9">
            <div class="d-flex justify-content-between align-items-center flex-column flex-md-row mb-4">
                ...
                <div>
                    ...
                    <select name="sort_price" id="sort_price" data-style="btn-selectpicker" title=""
                        class="selectpicker">
                        <option value="">Semua</option>
                    ...
                    <div data-marker-id="59c0c8e33b1527bfe2abaf92" class="col-sm-6 col-xl-4 mb-5 hover-animate">
                        <div class="card h-100 border-0 shadow">
                            <div class="card-img-top overflow-hidden gradient-overlay"> <img
                                    src="{{ Storage::url('public/'.$krs->gambar_kursus) }}"
                                ...
                                <div class="card-img-overlay-bottom z-index-20">
                                    <div class="media text-white text-sm align-items-center">
                                        ...
                                        <img src="{{ Storage::url('public/'.$sensei->foto) }}"
                                            alt="{{ $sensei->nama_tutor }}"
