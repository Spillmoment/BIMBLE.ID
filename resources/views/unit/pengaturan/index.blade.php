...
@section('title','Bimble - Pengaturan Unit')
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Pengaturan Unit </li>
                        </ol>
                    </div>
                </div>
            </div>
...
<div class="content">
    ...
    <div class="card">
        <div class="card-header">
            <strong>Pengaturan Unit
                <span class="badge badge-pill badge-primary"> {{ Auth::user()->nama_unit }} </span>
            </strong>
        </div>
        <div class="card-body card-block">
            <form method="post" enctype="multipart/form-data" action="{{route('unit.update-pengaturan', Auth::id() )}}">
                @csrf
                @method('PUT')
