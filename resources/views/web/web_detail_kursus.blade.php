                    ...
                    <div class="text-block">
                        <div class="form-group">
                            ...
                            <select name="sort" id="form_sort" data-style="btn-selectpicker" title=""
                                ...
                                <option value="sortBy_0">Senin - Kamis</option>
                                <option value="sortBy_1">Selasa - Rabu </option>
                                <option value="sortBy_2">Sabtu - Minggu </option>
                                <option value="sortBy_3">Rabu - Kamis </option>
                                <option value="sortBy_4">Senin - Jumat </option>
                            </select>
                        </div>

                        <div class="form-group">
                            <label for="form_sort" class="form-label ">Jam Kursus</label>
                            <select name="sort" id="form_sort" data-style="btn-selectpicker" title=""
                                class="selectpicker form-control">
